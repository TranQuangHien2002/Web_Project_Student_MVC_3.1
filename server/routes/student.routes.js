...
router.get("/:roomId", studentController.getByRoomId); //Định nghĩa một route GET. Khi nhận được một yêu cầu HTTP GET đến đường dẫn /:roomId, nó sẽ gọi hàm getByUserId trong studentController.
...
router.post("/create/:roomId", studentController.createStudentWithRoomId); //Định nghĩa một route POST. Khi nhận được một yêu cầu HTTP POST đến đường dẫn /create/:userId, nó sẽ gọi hàm createStudentWithUserId trong studentController.
