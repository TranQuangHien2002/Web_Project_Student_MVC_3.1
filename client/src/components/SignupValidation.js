//Đây là một hàm Validation trong JavaScript, được sử dụng để kiểm tra tính hợp lệ của tên, email và mật khẩu.
...
function Validation(values){
    ...
    if(values.name ===""){
        //Kiểm tra nếu tên trống, thì thêm lỗi vào đối tượng errors
...
export default Validation;//Trả về đối tượng errors chứa tất cả các lỗi tìm thấy.